        ...
        <div  className='py-30  px-10'>
            <div className='flex justify-center items-center  flex-col'>
                ...
                <div className='flex gap-6'>
                    <NavLink to="/Browse" className='b_gradient rounded-full px-5 py-3  font-semibold text-white    text-lg'><button className='flex items-center'><Search className='mr-3 size-4' strokeWidth={2} />Browse Items</button></NavLink>
